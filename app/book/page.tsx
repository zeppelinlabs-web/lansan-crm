...
export default function PublicBookingPage() {
  const { addAppointment, addContact, contacts, showToast } = useCRM();
  ...
  const [meetingType, setMeetingType] = useState<{
    ...
    id: 'demo',
    name: '30-Min Product Demo & Walkthrough',
    duration: '30 mins',
    desc: 'Live interactive demonstration of Lansan CRM pipeline, automations, and AI features.',
  });
  ...
  const meetingTypes = [
    {
      ...
      duration: '15 mins',
      desc: 'Quick intro call to discuss your sales goals and see if Lansan CRM fits your workflow.',
    },
    {
      id: 'demo',
      name: '30-Min Product Demo & Walkthrough',
    ...
    {
      id: 'strategy',
      name: '60-Min Executive Strategy Session',
      duration: '60 mins',
      desc: 'Deep dive pipeline audit, custom integration scoping, and enterprise onboarding.',
    },
  ];
  ...
  const handleBooking = (e: React.FormEvent) => {
    ...
    setBooked(true);
    showToast(`🎉 Appointment booked with Lansan CRM for ${selectedDate} at ${selectedTime}!`);
  };
        ...
        {!booked ? (
          ...
          >
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
                ...
                <div>
                  <div style={{ fontWeight: 700, fontSize: '15px' }}>Lansan CRM Team</div>
                  <div style={{ fontSize: '12px', color: '#64748b' }}>Schedule a Meeting</div>
                </div>
              </div>
          ...
          <div style={{ padding: '60px 40px', textAlign: 'center' }}>
            ...
            <p style={{ fontSize: '15px', color: '#64748b', maxWidth: '500px', margin: '0 auto 28px auto' }}>
              A calendar invitation with video call details has been sent to <strong>{email}</strong> and synchronized with Lansan CRM.
            </p>
            ...
            <div style={{ display: 'flex', gap: '12px', justifyContent: 'center' }}>
              ...
              <Link href="/appointments">
                <Button variant="sm">
                  View in Lansan CRM Appointments
                </Button>
              </Link>
            </div>
          </div>
